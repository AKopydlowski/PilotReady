...
const DICT: Record<Lang, Record<string, string>> = {
  pl: {
    ...
    "admin.subtitle": "Zgłoszenia użytkowników i analityka aplikacji w jednym miejscu.",
    "admin.tab.reports": "Zgłoszenia",
    ...
    "admin.analytics.loading": "Ładowanie analityki…",
    "admin.analytics.error": "Nie udało się pobrać analityki.",
    "admin.analytics.window": "24h: {d1} · 7d: {d7} · 30d: {d30}",
    "admin.analytics.users": "Użytkownicy",
    "admin.analytics.visits": "Wizyty",
    "admin.analytics.uniqueVisitors": "Unikalni goście",
    "admin.analytics.activeUsers7d": "Aktywni (7 dni)",
    "admin.analytics.totalAnswers": "Udzielone odpowiedzi",
    "admin.analytics.reports": "Zgłoszenia",
    "admin.analytics.reportsBreakdown": "Nowe {n} · W trakcie {p} · Rozwiązane {r} · Odrzucone {x}",
    "admin.analytics.visitsByDay": "Wizyty (14 dni)",
    "admin.analytics.signupsByDay": "Rejestracje (14 dni)",
    "admin.analytics.usersList": "Lista użytkowników",
    "admin.analytics.usersCount": "{n} kont",
    "admin.analytics.colUser": "Użytkownik",
    "admin.analytics.colJoined": "Dołączył",
    "admin.analytics.colAnswers": "Odpowiedzi",
    "admin.analytics.colReports": "Zgłoszenia",
    "admin.analytics.colVisits": "Wizyty",
    "admin.analytics.colLastActive": "Ostatnia aktywność",
    "admin.analytics.adminBadge": "Admin",
    "admin.analytics.generatedAt": "Dane na {date}",
  ...
  en: {
    ...
    "admin.subtitle": "User reports and app analytics in one place.",
    ...
    "admin.analytics.error": "Could not load analytics.",
    "admin.analytics.window": "24h: {d1} · 7d: {d7} · 30d: {d30}",
    "admin.analytics.users": "Users",
    "admin.analytics.visits": "Visits",
    "admin.analytics.uniqueVisitors": "Unique visitors",
    "admin.analytics.activeUsers7d": "Active (7 days)",
    "admin.analytics.totalAnswers": "Answers given",
    "admin.analytics.reports": "Reports",
    "admin.analytics.reportsBreakdown": "New {n} · In progress {p} · Resolved {r} · Rejected {x}",
    "admin.analytics.visitsByDay": "Visits (14 days)",
    "admin.analytics.signupsByDay": "Signups (14 days)",
    "admin.analytics.usersList": "User list",
    "admin.analytics.usersCount": "{n} accounts",
    "admin.analytics.colUser": "User",
    "admin.analytics.colJoined": "Joined",
    "admin.analytics.colAnswers": "Answers",
    "admin.analytics.colReports": "Reports",
    "admin.analytics.colVisits": "Visits",
    "admin.analytics.colLastActive": "Last active",
    "admin.analytics.adminBadge": "Admin",
    "admin.analytics.generatedAt": "Data as of {date}",
